# intentional-log: this module is the explicit console fallback for GUI diagnostics.
#
...
from gitrepo.build_package.core.config import APP_NAME, LOG_DIR_BASE
...
class GTKLogger:
    ...
    def _show_fatal_error_dialog(self, message: str, exit_code: int):
        ...
        try:
            ...
            # Create error dialog
            dialog = Adw.MessageDialog.new(self.main_window, _("Fatal Error"), message)
